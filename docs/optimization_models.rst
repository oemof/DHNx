...
* **cap_min**: Minimum installable capacity (e.g. [kW]). Note that there is a difference if a
  *nonconvex* investment is applied (see `oemof-solph documentation <https://oemof-solph.readthedocs.io/en/v0.5.7/usage.html#investment-optimisation>`_
...
`oemof-solph handling results <https://oemof-solph.readthedocs.io/en/v0.5.7/usage.html#handling-results>`_.
