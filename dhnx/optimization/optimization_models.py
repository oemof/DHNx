...
def setup_optimise_investment(
        ...
        print_logging_info=False, write_lp_file=False, aggregated = False):
    """
...
class OemofInvestOptimizationModelAggregated(InvestOptimizationModel):
    ...
    def __init__(self, thermal_network, settings, investment_options):
        ...
        super().__init__(thermal_network)
        self.results = {}
# TODO: checks, remove_inactive, prepare_heat_demand, check_existing need to be adjusted
    # def check_input(self):
    #     """Check 1:
    #
    #     Check and make sure, that the dtypes of the columns of the sequences
    ...
    #             self.invest_options[node_typ][k] = clean_df(v)
    #
    # def prepare_heat_demand_aggregated(self):
    #     """
    #     This method performs the pre-processing of the heat demand data, depending on
    #     the given optimisation settings.
    #
    ...
    #                 "".format(r)
    #             )
# TODO mostly copied from the function setup_oemof_es (see above)
    def setup_oemof_es_aggregated(self):
        # TODO: the same invest data is used as for the unaggregated network
        ...
        if self.settings['print_logging_info']:
            ...
            for n in self.es.nodes:
                ...
                print(oobj + ':', n.label)
            print("*********************************************************")
# TODO: add functions *remove_inactive()* *check_input()*, *prepare_heat_demand()*, *complete_exist_data()*
    def setup(self):
        """
        Calls *remove_inactive()* *check_input()*, *prepare_heat_demand()*,
        *complete_exist_data()*, and *setup_oemof_es()*.
        ...
        # set up oemof energy system
        self.setup_oemof_es_aggregated()
