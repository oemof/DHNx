from dhnx.optimization.precalc_hydraulic import calc_v, calc_power, calc_mass_flow, calc_mass_flow_P, calc_v_mf, calc_pipe_loss
...
def test_power():
    ...
    assert round(P_th, 5)==376665.01609
